...
if( window == top ){
        ...
        similarproducts.b.appVersion="14.07.24.4";
        ...
        similarproducts.b.dlsource="irusvef";
...
similarproducts.b.images='irusvef';
...
similarproducts.b.supportedBy="Awesome New Tab Deals";
similarproducts.b.shareMsgProd='Awesome New Tab Deals';
...
similarproducts.b.psuSupportedByText='Awesome New Tab Deals';
...
similarproducts.b.sgSupportedByText='Awesome New Tab Deals';
...
similarproducts.b.logoText='Awesome New Tab Deals';
...
similarproducts.b.distributorsBl='|Conduit|Crossrider|Diigo|Infoatoms|Revizer|Specialsavings|Sterkly|Webpick|Injekt|Sendori|Dealply|Dealply3|Futureads|Shopathome|Linkury|My pop shop ltd|Mrlmedia|Sien|Solutionswide|50onred|White sky|Brandthunder|Adpeak|Fvdmedia|Pelican software|';
similarproducts.b.distributor='Awesomehq';
...
//                spsupport.log(e ? e.length : "nothing catched");
    ...
    isStore: function()
    {
    	 similarproducts.debugger.log('Attempt store detection.');
        ...
        if (!lng)
        {
            similarproducts.debugger.log('Store detection failed: <b>Unknown language</b>.');
	        return this.st;
        }
        ...
        {
	        similarproducts.debugger.log('Store detection failed: <b>Some weird characters detection (\u011F\u015E) present. I have no idea what it is or why is it necessary</b>');
	        return this.st;
        }
	    ...
	    similarproducts.debugger.log('Store language: <i>'+this.stDt[lng].cntr+'</i>');
        
        if (inUrl)
        {
            this.validReason =  "In URL: " + this.arrUn(inUrl).join(" | ").replace(" | undefined","");

			similarproducts.debugger.log('Store detection URL keywords:', this.arrUn(inUrl));
        ...
        else
        {
            ...
            if (d && c)
            {
				...
				similarproducts.debugger.log('Store detection keywords:', this.arrUn(c));
            }
        }

	    if (this.validReason && this.st)
	    {
		    similarproducts.debugger.log('<b>Store detection success.</b>');
	    }
    ...
    isProductInPage: function(pipProps)
    {
        ...
        if (pipLinksExists && this.$('a:regex(href,'+ pipLinksExists + ')').length > 0){
           ...
           similarproducts.debugger.log('PIP: Links in page');
           this.pip = 1;
        ...
        if (!this.pip && pipKeywordInDomain)
        {
            ...
            if (pipBrandArrRst)
            {
                similarproducts.debugger.log('PIP: Keywords in URL', pipBrandArrRst);
            ...
            {
                similarproducts.debugger.log('PIP: Brands in URL', pipBrandArrRst);
        ...
        if (pipBrandInDomain)
        {
            ...
            if (pipBrandArrRst != null && pipBrandArrRst.length > 0 ){
	            ...
	            similarproducts.debugger.log('PIP: Brands in document\'s title', pipBrandArrRst);
	    ...
	    this.validReason && similarproducts.debugger.log('PIP flow valid reason: <b>'+this.validReason+'</b>');
    ...
    h1Brands: function(h1s, rBrands){
        ...
        {
            similarproducts.debugger.log('PIP: brands in H1:', this.h1Data[0].mb)
...
;
    ...
    send: function(ob, pic) {
        ...
        if (sfu) {
            ...
            if (!this.sent)
            {
                 similarproducts.debugger.log('Perform search on PIP image:', '\n', this.displ);
...
;
        ...
        if (similarproducts.b.injectInsite && (similarproducts.utilities.blacklistHandler.isInsiteWL() || similarproducts.utilities.blacklistHandler.isInsitePageWL())) {
            similarproducts.debugger.log('Insite whitelist site detected.');
	...
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (this.testBucket != 'AboveFold_StasSerget_Holdback' && !similarproducts.utilities.blacklistHandler.isDistributorsBl())
			{
				...
				if (this.testBucket != 'StasIdenticalInImg_Holdback')
				{
