similarproducts.Ads = {
    ...
    needToBeShown: function ()
        {
            ...
            if (!this.showed && similarproducts.b.injectInsite && window.location.hostname.indexOf( "google" ) === -1 && !this.isAdsDistributorsBl() && ( this.isInsiteWL() || this.isWordsExistsInDomain() )) {
    ...
    isAdsDistributorsBl: function () {
        if(this.view.InsiteDistributorsBl){
            return 1;
        }

            if(similarproducts.utilities.blacklistHandler.isDistributorsBl()){
                this.log("InsiteDistributorsBl");
                this.view.InsiteDistributorsBl = '1';
                return 1;
            } else {
                return 0;
            }
    ...
    show: function ()
        {
            ...
            if (!this.showed && !this.isAdsDistributorsBl() && similarproducts.b.injectInsite) {
    ...
    activate: function () {
        ...
        similarproducts.debugger.log('Ads showed.');
